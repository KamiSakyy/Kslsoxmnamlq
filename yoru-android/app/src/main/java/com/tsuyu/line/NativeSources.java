...
public final class NativeSources {
    ...
    public Anime.Page catalog(String source,String search,int page)throws Exception{
        if(!source.equals(Sec.s("351d1c14-10370c02")))throw new IOException("Неизвестный маршрут");String base=Sec.s("3c07010906694a4c130810650a175e595c53");String html;
